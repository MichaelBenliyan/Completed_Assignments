...
const fizzbuzzbazz = num => {
    let solution = [];
    for (i=1; i <= num; i++) {
        if (i%5 === 0 && i%3 === 0 && i%7 === 0) solution.push('fizzbuzzbazz');
        else if (i%3 === 0 && i%5 === 0) solution.push("fizzbuzz");
        else if (i%3 === 0 && i%7 === 0) solution.push('fizzbazz');
        else if (i%5 === 0 && i%7 === 0) solution.push('buzzbazz');
        else if (i%3 === 0) solution.push('fizz');
        else if (i%5 === 0) solution.push('buzz');
        else if (i%7 === 0) solution.push('bazz');
